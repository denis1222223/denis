namespace SprintsManager.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SprintsManager.Data.Models.SprintsManagerContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "SprintsManager.Data.Models.SprintsManagerContext";
        }

        protected override void Seed(SprintsManager.Data.Models.SprintsManagerContext context)
        {
